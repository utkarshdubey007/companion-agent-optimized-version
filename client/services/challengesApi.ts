  ...
  data: [
    {
      challenge: {
        ...
        id: 269,
        picture_url: "http://localhost:8000/media/challenges/60f0280f-4fb0-4014-b453-c03a95f181c2/image.jpeg",
        picture_height: 270,
        picture_width: 480,
...
export class ChallengesApiService {
  ...
  private static readonly AUTH_COOKIES = '_fbp=fb.0.1752251216171.237035461266330472; _ga=GA1.1.760378924.1752251225; __stripe_mid=950d6f3c-dbf1-4223-856e-8c637002fc643f7797; sessionid=ym7qxiur5kruzip1lv7jgrtp2fc9b7rt; _ga_JN6T86SWNW=GS2.1.s1753188967$o35$g1$t1753190505$j60$l0$h0';
   ...
   */
  static async getDependentChallengesWorking(dependentId: number = 2404): Promise<ChallengesResponse> {
    try {
      const response = await fetch(`/api/v2/challenges/dependent-challenges/working?dependent_id=${dependentId}`, {
        method: 'GET',
        headers: {
