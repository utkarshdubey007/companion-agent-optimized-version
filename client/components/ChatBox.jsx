...
export function ChatBox({ messages, onSendMessage, className = "" }) {
  ...
  const renderAITextMessage = (message) => (
  ...
  const renderChallengeMessage = (message) => (
  ...
  const renderKidTextMessage = (message) => (
  ...
  const renderKidFileMessage = (message) => {
    const getFileIcon = () => {
