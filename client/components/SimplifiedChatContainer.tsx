...
export function SimplifiedChatContainer({
  ...
  const renderMessage = (message: ChatMessage) => {
    ...
    if (message.sender === "AI") {
      return (
        <div className="absolute bottom-72 left-1/4 transform -translate-x-1/2" key={message.id}>
          <div className="max-w-sm">
  ...
  return (
    <div className={`flex flex-col h-full relative ${className}`}>
      ...
      <div className="absolute bottom-16 left-1/4 transform -translate-x-1/2 z-20 hover:scale-105 transition-transform duration-300">
      ...
      <div className="relative w-full h-full">
        ...
        {!latestAI && !latestKid && (
          <div className="absolute bottom-72 left-1/4 transform -translate-x-1/2">
            <div className="max-w-sm">
              <div className="bg-blue-500 text-white p-3 rounded-2xl rounded-bl-sm shadow-lg relative">
                <p className="text-sm leading-relaxed">
