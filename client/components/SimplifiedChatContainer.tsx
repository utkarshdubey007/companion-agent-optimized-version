...
export function SimplifiedChatContainer({
  ...
  const renderMessage = (message: ChatMessage) => {
    ...
    if (message.sender === "AI") {
      return (
        <div className="absolute bottom-96 left-1/2 transform -translate-x-1/2" key={message.id}>
  ...
  return (
    <div className={`flex flex-col h-full relative ${className}`}>
      ...
      <div className="absolute bottom-20 left-1/2 transform -translate-x-1/2 z-20 hover:scale-105 transition-transform duration-300">
