...
export function DualSidebar({
  ...
  return (
    <div className="fixed left-0 top-0 z-30 flex flex-col h-screen w-auto">
      ...
      <div className="flex flex-col gap-4 ml-4 my-4 h-[calc(100vh-2rem)] max-h-screen">
        {/* Top Sidebar Section */}
        <div className="relative flex-1 min-h-0">
          {/* Top Section Toggle Button - AcceptedChallenge style */}
          <div
          ...
          >
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20 shadow-lg h-full flex flex-col">
              {/* Header */}
        ...
        <div className="relative flex-1 min-h-0">
          {/* Bottom Section Toggle Button - AcceptedChallenge style */}
          <div
            className="absolute z-20 transition-all duration-700"
            style={{
