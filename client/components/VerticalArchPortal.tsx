      ...
      >
        ...
        >
          <div className="relative w-5 h-5">
            <div className="absolute w-5 h-0.5 bg-yellow-300 left-0 top-1/2 transform -translate-y-1/2"
                 style={{ boxShadow: "0 0 15px rgba(255, 215, 0, 1)" }} />
            <div className="absolute w-0.5 h-5 bg-yellow-300 left-1/2 top-0 transform -translate-x-1/2"
                 style={{ boxShadow: "0 0 15px rgba(255, 215, 0, 1)" }} />
