...
const mockChallengesData = [
  {
    challenge: {
      ...
      id: 269,
      picture_url:
        "https://images.unsplash.com/photo-1481627834876-b7833e8f5570?w=480&h=270&fit=crop",
      picture_height: 270,
      picture_width: 480,
      ...
      completed_dependents: [
        {
          ...
          profile: {
            picture_url:
              "https://images.unsplash.com/photo-1544725176-7c40e5a71c5e?w=459&h=480&fit=crop&crop=face",
            picture_height: 480,
            picture_width: 459,
            gender: "female",
  ...
  },
  {
    challenge: {
      ...
      description:
        "Reflect on a memory that makes you happy. What are the details you cherish the most about it?",
      hash_tags: [],
      created_by: {
        first_name: "Kim",
        last_name: "Lee",
      ...
      id: 39,
      picture_url:
        "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1312&h=700&fit=crop",
      picture_height: 700,
      picture_width: 1312,
      ...
      completed_dependents: [
        {
          ...
          profile: {
            picture_url:
              "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=381&h=480&fit=crop&crop=face",
            picture_height: 480,
            picture_width: 381,
            gender: "male",
            taletree_friend: "",
  ...
  },
  {
    challenge: {
      ...
      id: 387,
      picture_url:
        "https://images.unsplash.com/photo-1512389142860-9c449e58a543?w=245&h=137&fit=crop",
      picture_height: 137,
      picture_width: 245,
...
export const getDependentChallengesWorking: RequestHandler = (req, res) => {
  try {
    ...
    console.log(
      "Challenges API Request received for dependent_id:",
      dependentId,
    );
    ...
    console.log(
      "🎉 Challenges Authentication successful - sessionid:",
